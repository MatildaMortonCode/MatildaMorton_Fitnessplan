...
def fineout(goal, fitness_level)

if goal == 1 && fitness_level == 1
    puts "Second fitness option, your file will download soon"
    tempfile = Down.download("https://raw.githubusercontent.com/MatildaMortonCode/MatildaMorton_Fitnessplan/main/docs/Loose-weight.jpg")
...
#If user selected Gain muscle 
        ...
        puts "Second fitness option, your file will download soon" 
        tempfile = Down.download("https://raw.githubusercontent.com/MatildaMortonCode/MatildaMorton_Fitnessplan/main/docs/Build-muscle-plan.jpg")
        FileUtils.mv(tempfile.path, "./#{tempfile.original_filename}")
...
# If user selected gain energy
        ...
        puts "Second fitness option, your file will download soon" 
        tempfile = Down.download("https://raw.githubusercontent.com/MatildaMortonCode/MatildaMorton_Fitnessplan/main/docs/Energy.jpg")
        FileUtils.mv(tempfile.path, "./#{tempfile.original_filename}")
